...
num1 = num2
print(f'num1 -> {id(num1)}, {type(num1)}') # num1 -> 2822058929344, <class 'list'>
print(f'num2 -> {id(num2)}, {type(num2)}') # num2 -> 2822058929344, <class 'list'>

print('-'*70) # 2번째 파일 : 주소 복사한 리스트의 원소 변경

num1[0] = 77  # num1 = num2 후 num1[0] 변경
print(f'num1 -> {id(num1)}, {type(num1)}') # num2 -> 2569407556800, <class 'list'>
print(f'num2 -> {id(num2)}, {type(num2)}') # 같은 주소!
