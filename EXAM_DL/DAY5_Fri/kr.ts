export const KR = {
   ...
   GalileoGalileiDesc: "+%{value} 잉여 작업자당 과학 생산",
   RamessesII: "람세스 2세",
   ...
   StatisticsOfficeDesc: "제국의 통계 정보를 제공합니다. 지도를 탐험하는 탐험가를 생산합니다.",
   ...
   MountSinai: "시나이 산",
   MountSinaiDesc:
   "발견되면, 현재 시대의 위인이 탄생합니다. 신앙을 생산하는 모든 건물은 +5의 저장 용량 배수를 얻습니다.",
   Alps: "알프스 산맥",
